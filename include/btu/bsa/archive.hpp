...
public:
    ...
    static tl::expected<Archive, common::Error> read_tes3(Path path);
    static tl::expected<Archive, common::Error> read_tes4(const Path &path);
    static tl::expected<Archive, common::Error> read_fo4(Path path);
    ...
    [[nodiscard]] static auto read(Path path) -> tl::expected<Archive, common::Error>;
